...
const retentionOptions = [
  ...
  { id: '4', title: '5 Year', heading:'Extended retention for compliance', desc: 'Required for some regulatory requirements and audits.' },
  { id: '5', title: 'Indefinite', heading:'Keep data until manually deleted', desc: 'Data retained until you request deletion. Not recommended for privacy.' },
          ...
          {retentionOptions.map((item) => {
            ...
            return (
              ...
              >
                ...
                {/* Check Icon (ABSOLUTE – no layout shift) */}
                {isSelected && (
                  <Ionicons
      ...
      <Text className="text-xl font-extrabold text-purple-500 my-5">
        ...
        <View className="border border-gray-200 rounded-xl overflow-hidden">
         ...
         <View className="w-96 h-24  bg-blue-200 rounded-2xl px-5 justify-center  my-5 shadow-lg border-l-4 border-blue-500">
          ...
          <View className=' bg-turquoise py-4 flex-row w-96 justify-center gap-3 rounded-lg  '>
           <Ionicons name="save-outline" size={24} color="white" />
           <Text className='text-xl text-white font-semibold'>Save retention setting</Text> 
